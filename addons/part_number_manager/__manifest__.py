...
""",
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'part_number_manager/static/src/pending_approval_badge/pending_approval_badge.scss',
            'part_number_manager/static/src/pending_approval_badge/pending_approval_badge_patch.js',
            'part_number_manager/static/src/pending_approval_badge/pending_approval_badge_patch.xml',
        ],
    },
    'installable': True,
    'application': True,
