...
""",
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'part_number_manager/static/src/part_number_list/pnm_part_number_list.js',
            'part_number_manager/static/src/part_number_list/pnm_part_number_list.xml',
            'part_number_manager/static/src/part_number_list/pnm_monetary_thousands_field.js',
