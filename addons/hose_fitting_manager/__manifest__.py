...
""",
    ...
    'data': [
        ...
        'views/job_equipment_item_views.xml',
        'views/wire_wizard_views.xml',
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'hose_fitting_manager/static/src/equipment_items/equipment_items.scss',
            'hose_fitting_manager/static/src/equipment_items/equipment_items.js',
            'hose_fitting_manager/static/src/equipment_items/equipment_items.xml',
            'hose_fitting_manager/static/src/port_board/port_board.scss',
            'hose_fitting_manager/static/src/port_board/port_board.js',
            'hose_fitting_manager/static/src/port_board/port_board.xml',
