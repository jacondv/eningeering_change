...
// Always renders as "5 Aug, 26" (day before month, 2-digit year),
// regardless of the user's language/locale date format - unlike the
// standard Date widget, whose text mode (numeric=false) ignores
// Settings > Languages > Date Format and always follows the browser
// locale instead.
export class DayMonthDateField extends DateTimeField {
    getFormattedValue(valueIndex, numeric = this.props.numeric) {
        ...
        return value.toFormat("d MMM, yy");
    }
}
