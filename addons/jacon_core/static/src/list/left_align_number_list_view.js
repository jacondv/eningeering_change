...
// Generic variant (plain list view, not the Project app's own) - for any
// other module's list that wants the same darker zebra striping without
// being Project/Task themselves, e.g. engineering_change's request list.
export const jaconCoreListView = {
    ...listView,
    Renderer: withLeftAlignedNumberColumns(listView.Renderer),
};
registry.category("views").add("jacon_core_list", jaconCoreListView);
